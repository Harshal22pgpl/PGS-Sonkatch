...
<span class="absolute inset-0 max-w-full max-h-full transition-all duration-300 ease-out transform translate-x-0 -skew-x-12 bg-[#c7b207] group-hover:bg-[#f6fdc4] group-hover:skew-x-12"></span>
<span class="absolute inset-0 max-w-full max-h-full transition-all duration-300 ease-out transform skew-x-12 bg-[#fdec12] group-hover:bg-[#fdec12] group-hover:-skew-x-12"></span>
