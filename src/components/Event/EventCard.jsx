...
const eventDetails = {
  ...
  month: "January",
  year: "2024",
  location: "LNCT College, SONKATCH",
  startTime: "2.30 pm",
  endTime: "5.30pm",
...
const EventCard = ({ eventDetails }) => {
  ...
  return (
    <>
      <div className="group w-full md:h-52 lg:h-52 sm:h-48 h-44 border-2 border-gray-300 rounded-2xl flex justify-around items-center p-2 md:p-4 sm:p-2 lg:p-4 hover:bg-[#fdec12] hover:text-white">
