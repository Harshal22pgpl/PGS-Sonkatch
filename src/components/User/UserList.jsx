                ...
                <tr class="bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                  ...
                  <td class="px-4 py-3 text-xs">
                    <span
                      class={`px-2 py-1 font-semibold leading-tight   ${
                        user.isActive
                          ? "bg-[#f6fdc4] text-[#c7b207]"
                          : "bg-red-700 text-white"
                      } rounded-full dark:${
                        user.isActive ? "bg-[#c7b207]" : "bg-red-700"
                      } dark:text-[#f6fdc4]`}
                    >
                  ...
                  <td className="px-4 py-3 text-xs">
                    <button
                      ...
                      className="bg-[#f6fdc4] hover:bg-[#c7b207] hover:text-white px-3 py-1 font-semibold leading-tight text-[#c7b207]"
                    >
                      Edit
                    </button>
                    <button
