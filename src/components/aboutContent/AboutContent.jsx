...
const About = () => {
  ...
  const images = [
    // '/homeGallary/HomeGallary (1).jpg',
    '/homeGallary/ev (7).jpg',
    '/homeGallary/ev (8).jpg',
    '/homeGallary/ev (1).jpg',
    // '/homeGallary/HomeGallary (2).jpg',
  ...
  const [cards, setCards] = useState([
    ...
    {
      name: "Mr. Rahul malviya",
      image: "/staff/Rahul malviya.jpg",
      qualification: "Bachelor's Degree in Early Childhood Education",
      description:
        "Ms. Sarah is a passionate educator with over 10 years of experience in guiding young minds. Her warm and nurturing approach creates a welcoming classroom environment where children feel comfortable.",
    },
    {
      name: "Mr. Hrituraj Pathak",
      image: "/staff/Hrituraj Pathak.jpg",
      qualification: "Bachelor's Degree in Early Childhood Education",
      description:
        "Ms. Sarah is a passionate educator with over 10 years of experience in guiding young minds. Her warm and nurturing approach creates a welcoming classroom environment where children feel comfortable.",
    },
    {
      name: "Ms. Muskan Namdev",
      image: "/staff/Muskan Namdev.jpg",
      qualification: "Bachelor's Degree in Early Childhood Education",
      description:
        "Ms. Sarah is a passionate educator with over 10 years of experience in guiding young minds. Her warm and nurturing approach creates a welcoming classroom environment where children feel comfortable.",
    },
      ...
      >
        <div className="md:max-w-[1480px] m-auto grid md:grid-cols-2 max-w-[600px]  px-4 md:px-0 mx-auto">
          <div className="flex flex-col justify-start gap-4 text-center">
            <p className="py-2 text-2xl text-[#fff829] font-medium">
              START TO SUCCESS
            </p>
            <h1 className=" py-2 md:text-6xl text-4xl font-semibold">
              Welcome to <span className="text-[#fff829]">PGS</span>{" "}
              <span className="text-[#fff829]">Learners</span> Academy
            </h1>
      ...
      <div className="">
        <div className="pt-6 md:p-8 text-center md:text-middle space-y-4 mb-5">
          ...
          <figcaption className="font-medium">
            ...
            {/* Buttons */}
            <div>
              <Button className="bg-[#fdec12] p-3 rounded mr-6">
        ...
        {/* Section: Philosophy */}
        <div className="my-10 " style={{ background: "#efde03" }}>
          {/* Image */}
          <img
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-5 mx-5">
            {cards.map((card, index) => (
              <div
                key={index}
                className="p-[20px] bg-white rounded-xl shadow-[#fdec12] border-gray-200 rounded-lg shadow flex-col justify-start items-start gap-[30px] inline-flex"
              >
                ...
                <div className="self-stretch p-[20px] bg-[#f6fdc4] rounded-xl shadow-lg flex-col justify-start items-start gap-5 flex">
