...
const AdmissionForm = () => {
    ...
    const images = [
        '/homeGallary/ev (7).jpg',
    '/homeGallary/ev (8).jpg',
    '/homeGallary/ev (9).jpg',
    '/homeGallary/ev (2).jpg',
    '/homeGallary/ev (4).jpg',
    ...
    const sliderImages = [
      {
        id: 1,
        url: "/homeGallary/ev (7).jpg",
      },
      {
        id: 3,
        url: "/homeGallary/ev (3).jpg",
      },
      {
        id: 5,
        url: "/homeGallary/ev (5).jpg",
      },
      {
        id: 7,
        url: "/homeGallary/ev (9).jpg",
      },
      {
        id: 8,
        url: "/homeGallary/ev (8).jpg",
      },
      ];
                    ...
                    <div className='flex flex-col md:flex-row md:justify-around items-center bg-cover'>
                        ...
                        <div className='flex flex-col justify-center items-center mt-5 md:mt-0 max-w-3xl'>
                            <h1 className="mb-4 text-center text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl">
                                <span className="text-transparent bg-clip-text bg-gradient-to-r to-[#fdec12] from-[#c7b207]">
                            ...
                            <button type="button" className="text-white  hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-pink-300 dark:focus:ring-pink-200 shadow-lg shadow-[#f6fdc4] dark:shadow-lg dark:shadow-[#f6fdc4] font-medium rounded-lg text-sm px-5 py-2.5 text-center"  style={{background:'#efde03'}}>
                                About Us
                            </button>
                        </div>
                    </div>
                    ...
                    <div className='w-full bg-white py-10 bg-cover ' style={{ backgroundImage: "url('/Rect Light.svg')" }}>
                        <div className='md:max-w-[1480px] m-auto grid md:grid-cols-2 max-w-[600px]  px-4 md:px-0 mx-auto'>
                            ...
                            <div className='flex flex-col justify-center gap-4 text-center'>
                                <p className='py-2 text-2xl text-[#fff829] font-medium'>Admission</p>
                                <h1 className='md:leading-[72px] py-2 md:text-6xl text-4xl font-semibold'>Join Our Family  <span className='text-[#fff829]'>of Young Learners </span>
                            ...
                            <div className="p-1.5 min-w-full inline-block align-middle">
                                <div className="overflow-hidden shadow-xl  rounded-lg">
                                    <table className="min-w-full divide-y divide-gray-200  dark:divide-gray-700 ">
                                        <thead>
                                            <tr>
                                                <th scope="col" className="bg-[#c7b207] px-6 py-3 text-center text-xs font-bold text-gray-100 uppercase">Programme</th>
                                                <th scope="col" className="bg-[#c7b207] px-6 py-3 text-center text-xs font-bold text-gray-100 uppercase">Age Group</th>
                                                <th scope="col" className="bg-[#c7b207] px-6 py-3 text-center text-xs font-bold text-gray-100 uppercase">Annual Tution</th>
                                            </tr>
                                        </thead>
                            ...
                            <div className="p-1.5 min-w-full inline-block align-middle">
                                <div className="overflow-hidden   shadow-xl rounded-lg">
                                    <table className="min-w-full divide-y divide-gray-200  dark:divide-gray-700">
                                        <thead>
                                            <tr>
                                                <th scope="col" className="bg-[#c7b207] px-6 py-3 text-center text-3xl font-medium text-gray-100 uppercase ">Additional Services</th>

                                                <th scope="col" className="bg-[#c7b207] px-6 py-3 text-center text-3xl font-medium text-gray-100 uppercase "></th>
                                            </tr>
                                        </thead>
